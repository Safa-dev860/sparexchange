...
// const ExchangeAccountConversationPage = () => {
//   const { id } = useParams();
...
//         const exchangeRef = doc(firestore, "Exchange", id);
...
//             id: exchangeSnap.id,
//             ...exchangeData,
//             createdAt: convertFirestoreTimestamp(exchangeData.createdAt),
//             updatedAt: convertFirestoreTimestamp(exchangeData.updatedAt),
//             owner: exchangeData.owner || {
...
//               db,
//               `products/${id}/conversations/${convId}`
//             );
...
//     e.preventDefault();
//     if (!newMessage.trim() || !activeConversation || !exchange) return;
...
//   if (loadingExchange || status === "loading") {
//     return (
...
//         </button>
//         <div>
//           <h1 className="text-2xl font-bold">{exchange.itemOffered}</h1>
//           <p className="text-gray-600">Wanted: {exchange.itemWanted}</p>
//         </div>
//       </div>
